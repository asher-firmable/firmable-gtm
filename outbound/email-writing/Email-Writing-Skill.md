...
- `knowledge/persona-messaging.md` — persona details, pain points, KPIs
- `knowledge/firmable-context.md` — Firmable positioning, tone
- `applications/ai.py` — `ask_claude()` function
- `applications/smartlead.py` — `add_leads_to_campaign()` for upload
