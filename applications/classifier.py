...
_ICP_CRITERIA_PATH = _REPO_ROOT / "knowledge" / "icp-criteria.md"
_PERSONA_MESSAGING_PATH = _REPO_ROOT / "knowledge" / "persona-messaging.md"
...
- Any "Manager", "Head of", "Director", "VP", "C-suite", "GM", "Partner" title
...
- "[Geography/Country/Region] Lead", "Market Lead", "Country Lead", "[Region] Lead" — titles indicating ownership of a geographic market with business development or growth responsibility (equivalent to a regional director)
...
**Default when uncertain:** If the title is manager/above AND B2B outreach is plausible (even if not obvious from the name alone), return Yes. Only return No when you are confident the company has no B2B dimension or the person is clearly an individual contributor.
