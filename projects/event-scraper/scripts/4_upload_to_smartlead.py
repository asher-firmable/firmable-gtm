...
Usage:
    python workflows/event_outbound/4_upload_to_smartlead.py --project projects/event_outbound/gitex_asia_2026
    python workflows/event_outbound/4_upload_to_smartlead.py --project projects/event_outbound/gitex_asia_2026 --dry-run
"""
