...
### Interactive CLI
```bash
PYTHONPATH=. python3 projects/slack-bots/find-contacts/scripts/bot.py
```
...
## Output
Write results to `projects/slack-bots/find-contacts/output/` (gitignored). Naming convention:
