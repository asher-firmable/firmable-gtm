...
Usage:
    python3 projects/slack-bots/event-scraper/scripts/0_scrape_sponsors.py --project projects/slack-bots/event-scraper/output/_template
    python3 projects/slack-bots/event-scraper/scripts/0_scrape_sponsors.py --project projects/slack-bots/event-scraper/output/_template --list-only
"""
