...
2. **Search for contacts** — use `client.find_contacts()` with filters:
   ...
   - Adjust filters based on the target persona (see `knowledge/persona-definitions.md`)
